...
public interface DBConnect {
    ...
    final static String PRODUCT_INSERT_UPDATE = "update product set pro_no = concat(cate_id, pro_no) where pro_no in (select pro_no from product order by regdate desc limit 1)";
