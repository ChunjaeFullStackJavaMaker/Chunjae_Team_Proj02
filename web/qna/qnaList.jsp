...
<head>
    ...
    <%
        ...
        while(rs.next()){
            ...
            qna.setVisit(rs.getInt("cnt"));
            qna.setLev(rs.getInt("lev"));
            qna.setPar(rs.getInt("par"));
            qna.setAuthor(rs.getString("name"));
                ...
                <div class="board_list_wrap">
                    <div class="board_list">
                        ...
                        <div>
                            ...
                            <div class="cnt"> <%=qna.getVisit()%> </div>
                    ...
                    <div class="btn_group" style="margin:0; width:1000px; padding-top:25px; ">
                        <% if(sid!=null) { %>
                        <a href="<%=path68%>/qna/addQuestion.jsp?lev=0&par=0" class="inbtn" style="float:right; ">질문하기</a>
                        <% } else { %>
