        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <nav class="header__menu">
                    <ul>
                        <li><a href="${path}/ProList.do?level=child"> 영유아 </a>
                        ...
                        <li><a href="${path}/ProList.do?level=elementary"> 초등 </a>
                            <ul class="header__menu__dropdown">
                        ...
                        <li><a href="${path}/ProList.do?level=middle"> 중등 </a>
                            <ul class="header__menu__dropdown">
                                <li><a href="${path}/product/getProduct.jsp"> 교과서 </a></li>
                                <li><a href=""> 참고서 </a></li>
                                <li><a href=""> 문제집 </a></li>
                        ...
                        <li><a href="${path}/ProList.do?level=high"> 고등 </a>
                            <ul class="header__menu__dropdown">
                                <li><a href="${path}/product/getProduct.jsp"> 교과서 </a></li>
                                <li><a href=""> 참고서 </a></li>
                                <li><a href=""> 문제집 </a></li>
